...
const Stack = () => {
  ...
  const categories = [
    {
      ...
      tools: [
        { name: 'ChatGPT', url: 'https://chat.openai.com', desc: 'OpenAI GPT-4o' },
        { name: 'Claude', url: 'https://claude.ai', desc: 'Anthropic' },
        { name: 'Gemini', url: 'https://gemini.google.com', desc: 'Google AI' },
        { name: 'Grok', url: 'https://grok.x.ai', desc: 'xAI' },
        { name: 'Deepseek', url: 'https://chat.deepseek.com', desc: isZh ? '深度求索' : 'Deep Reasoning' },
        { name: 'Kimi', url: 'https://kimi.moonshot.cn', desc: isZh ? '月之暗面' : 'Moonshot AI' },
      ] as Tool[],
    },
    {
      title: isZh ? 'AI 编程' : 'AI Coding',
      tools: [
        { name: 'Cursor', url: 'https://cursor.so', desc: isZh ? 'AI 代码编辑器' : 'AI Code Editor' },
        { name: 'Claude Code', url: 'https://claude.ai/code', desc: isZh ? 'Anthropic 编程助手' : 'Anthropic Coding' },
        { name: 'Codebuddy', url: 'https://codebuddy.ai', desc: isZh ? 'AI 编程伙伴' : 'AI Pair Programmer' },
        { name: 'Trae', url: 'https://trae.ai', desc: isZh ? '字节 AI IDE' : 'ByteDance AI IDE' },
        { name: 'Kiro', url: 'https://kiro.dev', desc: 'AWS AI IDE' },
        { name: 'Qodo', url: 'https://qodo.ai', desc: isZh ? 'AI 代码质量' : 'AI Code Quality' },
      ] as Tool[],
    },
    {
      ...
      tools: [
        {
          ...
          bestPractice: {
            zh: '我个人推荐：前端用 Bolt 生成，后端直接让 Claude Code 通过 InsForge MCP 建表、写函数、配密钥——真·从零到上线一条龙。',
            en: 'My pick: pair it with Bolt for the frontend and let Claude Code drive InsForge MCP to create tables, write functions, and manage secrets — zero-to-live in one flow.',
          },
        },
        { name: 'Bolt.new', url: 'https://bolt.new', desc: isZh ? '快速原型构建' : 'Rapid Prototyping' },
        { name: 'Replit', url: 'https://replit.com', desc: isZh ? '在线 IDE + AI' : 'Online IDE + AI' },
      ] as Tool[],
    },
    {
      title: isZh ? 'AI 创意生成' : 'AI Creative',
      tools: [
        { name: 'Kling AI', url: 'https://klingai.com', desc: isZh ? '快手 AI 视频' : 'Kuaishou AI Video' },
        { name: 'Dreamina', url: 'https://dreamina.capcut.com', desc: isZh ? '字节 AI 图像' : 'ByteDance AI Image' },
        { name: 'IMA', url: 'https://ima.art', desc: isZh ? 'AI 艺术创作' : 'AI Art Creation' },
      ] as Tool[],
    },
    {
      title: isZh ? '效率工具' : 'Productivity',
      tools: [
        { name: 'Notion', url: 'https://notion.so', desc: isZh ? '全能笔记协作' : 'All-in-one Workspace' },
        { name: 'Figma', url: 'https://figma.com', desc: isZh ? '协作设计' : 'Collaborative Design' },
        { name: 'NotebookLM', url: 'https://notebooklm.google.com', desc: isZh ? 'Google AI 笔记' : 'Google AI Notes' },
        { name: 'vvcard', url: 'https://vvcard.me', desc: isZh ? '数字名片' : 'Digital Business Card' },
      ] as Tool[],
    },
    {
      title: isZh ? '渠道矩阵 · 海外' : 'Channels · Global',
      tools: [
        { name: 'Twitter / X', url: 'https://twitter.com', desc: isZh ? '全球社交媒体' : 'Global Social Media' },
        { name: 'YouTube', url: 'https://youtube.com', desc: isZh ? '视频内容平台' : 'Video Platform' },
        { name: 'LinkedIn', url: 'https://linkedin.com', desc: isZh ? '职业社交网络' : 'Professional Network' },
        { name: 'Medium', url: 'https://medium.com', desc: isZh ? '优质内容社区' : 'Quality Content Community' },
        { name: 'Product Hunt', url: 'https://producthunt.com', desc: isZh ? '产品发布平台' : 'Product Launch Platform' },
      ] as Tool[],
    },
    {
      title: isZh ? '渠道矩阵 · 国内' : 'Channels · China',
      tools: [
        { name: isZh ? '微信公众号' : 'WeChat Official', url: 'https://mp.weixin.qq.com', desc: isZh ? '内容订阅平台' : 'Content Subscription' },
        { name: isZh ? '小红书' : 'Xiaohongshu', url: 'https://xiaohongshu.com', desc: isZh ? '生活方式社区' : 'Lifestyle Community' },
        { name: isZh ? '即刻' : 'Jike', url: 'https://okjike.com', desc: isZh ? '兴趣社交' : 'Interest-based Social' },
        { name: isZh ? '知乎' : 'Zhihu', url: 'https://zhihu.com', desc: isZh ? '知识问答社区' : 'Q&A Community' },
        { name: isZh ? 'B站' : 'Bilibili', url: 'https://bilibili.com', desc: isZh ? '视频弹幕社区' : 'Video Community' },
      ] as Tool[],
    },
  ];
  ...
  const sources = [
    ...
    { name: 'a16z', url: 'https://a16z.com', desc: isZh ? '风投与创新洞察' : 'VC & innovation insights' },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32 pb-20 px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          ...
          >
            {isZh
              ? '我实际在用的工具 + 我在关注的信息源。不是榜单，是当前的工作台。'
              : "Tools I actually use + sources I actually follow. Not a listicle — my current workbench."}
          </motion.p>
          ...
          <motion.h2
            ...
            className="text-2xl font-serif font-light text-foreground mb-6"
          >
            {isZh ? '我在用的工具' : 'Tools I Use'}
          </motion.h2>
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-2xl font-serif font-light text-foreground mt-20 mb-6"
          >
            {isZh ? '我关注的信息源' : 'Sources I Follow'}
          </motion.h2>
          ...
          <div className="grid gap-3">
            {sources.map((source, i) => (
              <motion.a
                ...
                className="group flex items-center justify-between p-5 border border-border rounded-lg hover:border-foreground/30 transition-colors"
              >
                <div>
